...
interface IsSensorAvailableResult {
  ...
  error?: string;
  isBiometricEnrolled?: string;
}

interface PromptEnrollBiometricsResult {
  success: boolean;
  error?: string;
}
...
export module ReactNativeBiometricsLegacy {
  ...
  export function promptEnrollBiometrics(): Promise<PromptEnrollBiometricsResult> {
    return new ReactNativeBiometrics().promptEnrollBiometrics();
  }
...
export default class ReactNativeBiometrics {
  ...
  promptEnrollBiometrics(): Promise<PromptEnrollBiometricsResult> {
    return bridge.promptEnrollBiometrics();
  }
